...
<hr>
<nav class="nav">
    <a id="h" class="active" href="1.html">Home</a>

<a id="Motive" href="3.html">Contact</a>
<a id="p" href="5.html">About</a>
<a id="l" href="index.html">Log In</a>
<a id="s" href="index.html">Sign In</a>
</nav>
</body>
<div class="section">
...
<table>
    ...
    <tbody>
      <tr>
        ...
        <td><a class="search" href="https://maps.app.goo.gl/AH35E1rohYk9uY3j9"target="_blank" ></a></td>
      </tr>
      <tr>
        <td><button class="address" id="2">2 | Krishan Nagar</button></td>
        <td><?php echo $data2; ?></td>
        <td><a class="search" href="https://maps.app.goo.gl/ywSd1n7eDSQAY8KNA"target="_blank" ></a></td>
      </tr>
      <tr>
        <td><button class="address" id="3">3 | Krishan Nagar </button></td>
        <td><?php echo $data3; ?></td>
        <td><a class="search" href="https://maps.app.goo.gl/qdTLzjRCrZiHH53H6"
            target="_blank" ></a></td>
      </tr>
      <tr>
        <td><button class="address" id="4">4 | Krishan Nagar</button></td>
        <td ><?php echo $data4; ?></td>
        <td><a class="search" href="https://maps.app.goo.gl/nHGDU8vwchR44UyV6" target="_blank" ></a></td>
      </tr><tr>
        <td><button class="address" id="5">5 | Krishan Nagar</button></td>
        <td ><?php echo $data5; ?></td>
        <td><a class="search" href="https://maps.app.goo.gl/VRZu8j3TohBRCYzu9"target="_blank" ></a></td>
      </tr>
      <tr>
